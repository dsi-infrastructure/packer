...
#### Ubuntu 12.04 LTS
* Virtualbox 4.3.14 ([download](http://repository.srv.gov.pf/os/ubuntu-12.04-dev-virtualbox.box))
```
...
```
* Virtualbox 4.3.14 avec Chef ([download](http://repository.srv.gov.pf/os/ubuntu-12.04-dev-virtualbox.box))
```
